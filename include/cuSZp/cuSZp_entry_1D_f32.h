...
void cuSZp_compress_1D_fixed_f32(float* d_oriData, unsigned char* d_cmpBytes, size_t nbEle, size_t* cmpSize, float errorBound, cudaStream_t stream = 0);
void cuSZp_decompress_1D_fixed_f32(float* d_decData, unsigned char* d_cmpBytes, size_t nbEle, size_t cmpSize, float errorBound, cudaStream_t stream = 0);
...
// Variable datablock-size variants (dblockSize must be 32, 64, 128, or 256).
void cuSZp_compress_1D_plain_f32_dblk(float* d_oriData, unsigned char* d_cmpBytes, size_t nbEle, size_t* cmpSize, float errorBound, int dblockSize, cudaStream_t stream = 0);
void cuSZp_decompress_1D_plain_f32_dblk(float* d_decData, unsigned char* d_cmpBytes, size_t nbEle, size_t cmpSize, float errorBound, int dblockSize, cudaStream_t stream = 0);
